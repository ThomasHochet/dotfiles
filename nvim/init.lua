...
Kickstart.nvim is a template for your own configuration.
  ...
  wha your configuration is doing, and modify it to suit your needs.
...
require('lazy').setup({
  ...
  {
    -- Neovim Tree, first plugin added manually
...
vim.keymap.set('n', '<leader>b', '<Cmd>BufferPrevious<CR>', opts)
vim.keymap.set('n', '<leader><leader>w', '<Cmd>BufferClose<CR>', opts)
